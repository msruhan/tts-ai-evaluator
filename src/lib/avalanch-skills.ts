...
export const AVALANCH_SKILLS: string[] = [
  ...
  "In rationales, do NOT start with or refer to 'the speaker' (ambiguous). Both rationale_a and rationale_b MUST open with the exact same subject: English 'The audio…'. Both rationale_a_id and rationale_b_id MUST open with 'Suara…'. Never mix openings (e.g. A 'The delivery…' vs B 'The speech…', or A 'Penyampaian…' vs B 'Ucapan…').",
  "Bad: 'The speaker delivers the text with natural flow…' or mismatched A/B openings. Better: A 'The audio is highly natural…' and B 'The audio sounds unnatural…' (same opener, different judgment).",
